...
var render = function render() {
  ...
  }, [_vm._m(0), _vm._v(" "), _vm.equipments && _vm.equipments.data.length > 0 ? _c("tbody", _vm._l(_vm.equipments.data, function (equipment, index) {
    var _equipment$descriptio;
    return _c("tr", {
      key: index
    }, [_c("th", [_vm._v(_vm._s(equipment.type.name))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(equipment.serial_number))]), _vm._v(" "), _c("td", [_vm._v(_vm._s((_equipment$descriptio = equipment.description) !== null && _equipment$descriptio !== void 0 ? _equipment$descriptio : "Отсутствует"))])]);
